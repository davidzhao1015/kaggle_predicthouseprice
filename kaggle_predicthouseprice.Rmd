...
The [tutorial](https://topepo.github.io/caret/feature-selection-using-univariate-filters.html) of caret package provides an overview of various mehtods for feature selection:
- Wrapper 
  - recursive feature eliminaiton 
  - genetic algorithms 
  - simulated annealing 
- Filter 
  - univariate filters 
...
predictors <- dummies_train_missing3 %>% select(-SalePrice) 

rfWithinFilter <- sbf(predictors, 
                      dummies_train_missing3$SalePrice,
