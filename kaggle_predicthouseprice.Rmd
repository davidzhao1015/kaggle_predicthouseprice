...
dim(dummies_train_missing)  # 90 variables left in the resulting train set 
...
#### Feature selection - ordination analysis
...
dummies_train_nzv3 <- dummies_train_nzv2 %>% replace(is.na(.), 0) # replace NA with 0 
...
# spearman correlation on 90 variables 
res_num <- cor(dummies_train_missing, method = "spearman")
